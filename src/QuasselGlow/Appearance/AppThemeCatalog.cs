    ...
    private static AppThemePalette CreateGlowPalette(bool isDark)
    {
        return isDark
            ? new AppThemePalette(
                ShellBg: C("#0B0F14"),
                ShellPanel: C("#0F141A"),
                ShellPanelMuted: C("#12171E"),
                ShellBorder: C("#262D36"),
                InkStrong: C("#E8EDF2"),
                InkSoft: C("#9AA8B6"),
                AccentRust: C("#FF7A63"),
                AccentTeal: C("#4D94FF"),
                AccentSky: C("#1E3A5F"),
                AccentSand: C("#3A2F12"),
                ShellBackdropStart: C("#0B0F14"),
                ShellBackdropMid: C("#0B0F14"),
                ShellBackdropEnd: C("#0B0F14"),
                MessageRowBg: C("#0F141A"),
                MessageRowBorder: C("#1E252E"),
                MessageRowSelfBg: C("#12212F"),
                MessageRowSelfBorder: C("#2E5F8F"),
                MessageRowHighlightBg: C("#3A2F12"),
                MessageRowHighlightBorder: C("#8A6D22"),
                MessageRowStatusBg: C("#12171E"),
                ComposerSelection: C("#6B4D94FF"),
                WindowChromeHoverBg: C("#1A2129"),
                WindowChromePressedBg: C("#222A33"),
                WindowChromeCloseFg: C("#C0A79E"),
                ...
                BufferPrefixBg: C("#1A222B"))
            : new AppThemePalette(
                ShellBg: C("#E9ECEF"),
                ShellPanel: C("#FFFFFF"),
                ShellPanelMuted: C("#F4F6F8"),
                ShellBorder: C("#D5DAE0"),
                InkStrong: C("#1B2430"),
                InkSoft: C("#5D6B7A"),
                AccentRust: C("#C0402C"),
                AccentTeal: C("#2F6FD0"),
                AccentSky: C("#DFE9F5"),
                AccentSand: C("#FFF2CF"),
                ShellBackdropStart: C("#E9ECEF"),
                ShellBackdropMid: C("#E9ECEF"),
                ShellBackdropEnd: C("#E9ECEF"),
                MessageRowBg: C("#FFFFFF"),
                MessageRowBorder: C("#E6EAEF"),
                MessageRowSelfBg: C("#F2F7FF"),
                MessageRowSelfBorder: C("#B9CFEA"),
                MessageRowHighlightBg: C("#FFF2CF"),
                MessageRowHighlightBorder: C("#E6C164"),
                MessageRowStatusBg: C("#F4F6F8"),
                ComposerSelection: C("#6B4D94FF"),
                WindowChromeHoverBg: C("#E4E8ED"),
                WindowChromePressedBg: C("#D8DDE3"),
                WindowChromeCloseFg: C("#6B7480"),
